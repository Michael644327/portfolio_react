...
const routesBt = [
  ...
  { path: "/animalpara/store", element: StorePage, proj: "AnimalPara", title:"門市介紹", name:"門市介紹" },
  { path: "/animalpara/product", element: ProductPage, proj: "AnimalPara", title:"商品一覽", name:"商品一覽" },
